...
> **Note:** This Neovim config is part of the [dotfiles](https://github.com/rishavb123/.dotfiles) repo. To install via the unified setup, run `install.sh` from the repo root. The instructions below are for standalone Neovim/kickstart usage.
